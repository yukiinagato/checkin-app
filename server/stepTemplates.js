const STEP_TEMPLATES = {
  'zh-hans': [
    ...
    {
      id: 'equipment', category: 'guide', title: '设备使用', subtitle: 'Equipment Guide', type: 'group', content: '',
      children: [
  ...
  'zh-hant': [
    ...
    {
      id: 'equipment', category: 'guide', title: '設備使用', subtitle: 'Equipment Guide', type: 'group', content: '',
      children: [
  ...
  en: [
    ...
    {
      id: 'equipment', category: 'guide', title: 'Equipment Guide', subtitle: 'Equipment', type: 'group', content: '',
      children: [
  ...
  jp: [
    ...
    {
      id: 'equipment', category: 'guide', title: '設備の使い方', subtitle: 'Equipment Guide', type: 'group', content: '',
      children: [
  ...
  ko: [
    ...
    {
      id: 'equipment', category: 'guide', title: '설비 사용법', subtitle: 'Equipment Guide', type: 'group', content: '',
      children: [
